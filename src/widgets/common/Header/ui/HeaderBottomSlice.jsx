...
const HeaderBottomSlice = ({ setIsServiceModal, isServiceModal }) => {
  const patientsConfig = {
    items: ['Рекомендация перед приемом', 'Рекомендация после лечение', 'Гарантии'],
    initialSelectedItem: (
      <>
        Пациенты
        <IoIosArrowDown />
  ...
  const workExampleConfig = {
    ...
    minWidth: 230,
    links: [
      `/example?send=Протезирование All-on-4 и All-on-6`,
      `/example?send=Имплантация зубов`,
      `/example?send=Протезирование зубов`,
      `/example?send=Виниры`,
      `/example?send=Лечение зубов`,
      `/example?send=Художественная реставрация`,
      `/example?send=Отбеливание`,
      `/example?send=Брекеты`,
      `/example?send=Профессиональная чистка зубов`,
      `/example?send=Лечение дёсен`,
    ],
    initialSelectedItem: (
      <>
        Пример работы
  ...
  const feedbackConfig = {
    minWidth: 250,
    items: ['Отзывы', 'Интервью с пациентами', 'Отзывы в социальных сетях', 'Отзывы пациентов'],
    links: ['/reviews', '/reviews?tabIndex=2', '/reviews?tabIndex=3', '/reviews?tabIndex=4'],
    initialSelectedItem: (
      <>
        Отзыва
        <IoIosArrowDown />
  ...
  const priceConfig = {
    ...
    links: ['/price', '/price?tabId=1', '/price?tabId=2', '/price?tabId=3', '/price?tabId=4'],
    initialSelectedItem: (
      <>
        Цена
        <IoIosArrowDown />
  ...
  const aboutClientConfig = {
    minWidth: 210,
    items: ['О клинике', 'Сертификаты', 'Правовая информация', 'Реквизиты', 'Вакансии'],
    links: [
      '/about/clinic',

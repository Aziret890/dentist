...
export default function AllServices() {
  const [servicesTab, setServicesTab] = useState('Поиск по направлениям'.toLowerCase())
...
const allServicesArr = ['Поиск по направлениям', 'Поиск по проблемам', 'Когда все запущено']

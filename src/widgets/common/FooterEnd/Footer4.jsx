      ...
      <div className="zz flex items-start justify-between my-11">
        <div className="m-5 first 840:min-w-[180px] 1000:w-[300px] 1100:w-[220px] w-[284px]">
          ...
          <div className="fd mt-5">
            ...
            <h3 className="text-[#2CB2BB] text-xs font-medium ml-[27px] my-3">Заказать звонок</h3>
            <div className="">
        ...
        <div onClick={() => scroll1()} className="m-5 third 840:max-w-[140px] 1100:w-auto 1200:w-[284px]">
          <div className="flex items-center flex-col gap-4 mr-11">
            ...
            <button
              onClick={() => scroll()}
              className="how cursor-pointer flex items-center gap-3 opacity-90 hover:opacity-100 transition-opacity p-[2px] bg-black rounded-[5px] bg-gradient-to-t from-[#F2FAFB] to-[#F2FAFB] active:scale-95"
            >
        ...
        <div className="m-5 four 1100:w-[260px] 1200:w-[284px]">
          ...
          <div className="mt-6">
            <NavLink className="text-[#2CB2BB] text-sm ">Политика конфиденциальности</NavLink>

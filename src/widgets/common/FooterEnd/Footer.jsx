        ...
        <div className="py-5 apa-py-3">
          <div className="apa flex items-center justify-start flex-wrap gap-5">
            <div className="w-[405px]">
              <p className="text-sm">
                Проконсультируем вас по условиям и стоимости лечения, подберём врача и запишем вас на приём.
              </p>
              <p className="mt-3 text-sm">  Консультация займёт всего 30–40 минут.</p>
            </div>
            <div
              onClick={() => navigate()}
              className="how bo w-[316px] h-[90px] bg-white flex items-center justify-center gap-5"
            >
            ...
            <div
              onClick={() => (nav('/'), window.scroll(0, 6580))}
              className=" how bo w-[316px] h-[90px] bg-white flex items-center justify-center gap-5"
            >
              <span className="text-5xl text-[#2CB2BB]">
                <FiMessageSquare />

...
const Clinic = () => {
  ...
  useEffect(() => {
    axios("https://akmatovt.pythonanywhere.com/clinic/").then((res) =>
      setData(res.data)
    );
  }, []);
  return (
          ...
          <div className="info-clinic">
            <div className="clinic-description">
              <p data-aos="fade-up" data-aos-duration={3 * 300}>
                ...
                специалистов, на вооружении у которых новейшие методы и
                технологии. <br /> <br />
                Главный принцип лечения в нашем медицинском учреждении — это
                индивидуальный комплексный подход к каждому клиенту и высокое
                качество проводимых процедур. <br />
                ...
                кариеса, пломбирование каналов, исправление прикуса без
                брекетов, художественную реставрацию, профессиональное
                отбеливание ZOOM, лечение неприятного запаха изо рта, установку
                голливудских виниров (люминиры) и многие другие услуги. За
                плечами наших специалистов — большой опыт работы и владение

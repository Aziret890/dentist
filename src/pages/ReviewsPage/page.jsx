...
export default function ReviewsPage() {
  ...
  return (
    <main>
      <div className={clsx(`w-full h-[52px] opacity-60 pt-3 text-white bg-[#2CB2BB]`)}>
        <div className="container">Отзывы</div>
      </div>
      <div className="">
        <ReviewStartContent />
        <ReviewTab reviewPageIndex={reviewPageIndex} setReviewPageIndex={setReviewPageIndex} />
        <Rating />
        <InterviewsWithPatients />
        <Social />
        <Reviews>
          <div className="">
            <h1 className="text-2xl font-bold" data-aos="fade-up" data-aos-duration={1 * 300}>
              Отзывы пациентов
            </h1>
            <div className={styles.search}>
              <div className={styles['input-box']}>
                <label htmlFor="search">Врачи</label>
                <input type="text" name="search" placeholder="Поиск по врачу..." id="search" />
              </div>
              <button>
                <IoSearchOutline />
              </button>

    ...
    <section className="pt-20">
      <div className="container">
        <div className="flex items-center justify-between w-full h-[356px] bg-[#2CB2BB] px-32 pb-8">
          <div className="">
            <img
              ...
              src="https://s3-alpha-sig.figma.com/img/f29f/bb51/b9a2f9a3d87041a150e30461808f9fca?Expires=1711929600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=ojPhUFUoUFCE-j2pyEpc4KvjH2~o0E1GsXhN6WMiQGJgRYG7OZ2aTC3386l1Yy89kqVsugA7LzXVUK4i3T7a9MVE4K9RytQ8qjjCMsS6RTeFw2GRc8hSaC9eldh50biNu0TK2b1cbMw--rf2L-76yiVHrYNrTumwonkpdA-wv5qNS8CYnSdmZHRe-VtIqEoQzqJv4o-3z6-atTnpIq4S~V2GMt7qIEH1ilCaN7TtdOQdA~Bby8d3HDr1wf0aofyATyiOlfAbTrCp-7WfBlx3vEvOo0bM7IzXGOUVgN0-idwa0e3DbxfEljIxaxDgit4UtmlkSlVbxmIn4iVnPRehFQ__"
              alt="имумуимшуйим"
            />
          </div>
          <div className="mb-24">
        ...
        <div className="flex items-center justify-between my-11">
          <div data-aos="fade-right" className="w-[386px] h-[128px] bg-[#F2FAFB] flex items-center justify-center">
          ...
          <div data-aos="zoom-in-up" className="w-[386px] h-[128px] bg-[#F2FAFB] flex items-center justify-center">
            <div className="flex items-center justify-center gap-3">
              <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div data-aos="fade-left" className="w-[386px] h-[128px] bg-[#F2FAFB] flex items-center justify-center">
            <div className="flex items-center justify-center gap-3">
              <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path

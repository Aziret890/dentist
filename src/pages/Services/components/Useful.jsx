...
const Useful = () => {
  return (
    <div className="container">
      <h1 className="font-bold text-3xl text-[#253F41] my-11">Полезная информация</h1>
      ...
      <div data-aos="zoom-in-up" className="w-full h-[120px] bg-[#F85D5D] flex items-center justify-center my-16">
        <div className="flex items-center justify-center gap-5">
          ...
          <div className="">
            ...
            <p className="text-white">Скорее всего вам придётся делать операцию по наращиванию костной ткани</p>
          </div>
        </div>
      </div>
    </div>
